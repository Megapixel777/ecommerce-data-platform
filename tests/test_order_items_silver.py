...
def test_transform_order_items_filters_invalid_values(spark):
    data = [
...
def test_transform_order_items_calculates_total_item_value(spark):
    data = [
        ("A", 10.0, 2.0, datetime(2017, 4, 23, 13, 25, 15)),
    ]
...
def test_transform_order_items_extracts_shipping_date(spark):
    data = [
        ("A", 10.0, 2.0, datetime(2017, 4, 23, 13, 25, 15)),
    ]
